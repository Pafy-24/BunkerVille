...
namespace Gamekit3D
{
    ...
    public class PlayerControllerEditor : Editor
    {
        ...
        SerializedProperty PlayerGUIProp;
        SerializedProperty TerminalScreenGUIProp;
        SerializedProperty CaffeteriaScreenGUIProp;
        ...
        void OnEnable()
        {
            ...
            PlayerGUIProp = serializedObject.FindProperty("PlayerGUI");
            TerminalScreenGUIProp = serializedObject.FindProperty("TerminalScreenGUI");
            CaffeteriaScreenGUIProp = serializedObject.FindProperty("CaffeteriaScreenGUI");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(PlayerGUIProp, new GUIContent("PlayerGUI"));
            EditorGUILayout.PropertyField(TerminalScreenGUIProp, new GUIContent("TerminalScreenGUI"));
            EditorGUILayout.PropertyField(CaffeteriaScreenGUIProp, new GUIContent("CaffeteriaScreenGUI"));
